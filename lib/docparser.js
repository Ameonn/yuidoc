...
YUI.add('docparser', function(Y) {
    ...
    var Lang = Y.Lang,
        ...
        DIGESTERS = {
            ...
            'namespace': function(tagname, value, target) {
                ...
                if (!this.namespaces[value].description) {
    ...
    Y.extend(DocParser, Y.Base, {
        ...
        _containerToSetter: {
            ...
            'interfaceitems': undefined,
            'modules': CURRENT_MODULE,
            'files': CURRENT_FILE,
            'warnings': undefined
        },
        _getCurrentObject: function() {
            return this.get(CURRENT_CLASS) || this.get(CURRENT_INTERFACE);
        },
        ...
        **/
        ...
        processblock: function(block) {
            ...
            } else if (this.get(CURRENT_NAMESPACE) && target.itemtype) {
              this.namespaces[this.get(CURRENT_NAMESPACE)].globals.push(target);
            }
        },
