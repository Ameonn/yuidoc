...
YUI.add('doc-builder', function (Y) {
    ...
    Y.DocBuilder.prototype = {
        ...
        */
         ...
         */
        mergeExtends: function (info, classItems, first, type) {
            var self = this;
            ...
            if (info.extends || info.uses) {
                ...
                self.data[type + 'items'].forEach(function (v) {
                ...
                if (self.data[container][info.extends]) {
                    if (self.data[container][info.extends].extends || self.data[container][info.extends].uses) {
                        ...
                        classItems = self.mergeExtends(self.data[container][info.extends], classItems, false, type);
                    }
                }
            }
            return classItems;
